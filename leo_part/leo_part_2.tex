...
\begin{lstlisting}[language=Python, frame=single, framesep=8pt ]
...
\begin{itemize}
    ...
    \item  Set up of the parameters for solving both the Poisson and the Schrodinger equations.
    \item Definition of the loop that sweeps the value of the central barrier gate:
    \begin{lstlisting}[language=Python, frame=single, framesep=8pt ]
